...
export default function Social() {
  ...
  return (
    ...
    <BsTelephoneFill className="iconPhone" onClick={() => window.open("tel:0543113297", "_blank")} style={{cursor: 'pointer'}}/>
    <MdEmail className="iconEmail" onClick={sendEmail} style={{cursor: 'pointer'}}/>
